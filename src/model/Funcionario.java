...
public class Funcionario extends Pessoa{
    ...
    public void cadastrar(String nome, String num_matricula, String qualificacao,
            String descricao_qualicacao, String carga_horaria_semanal) {
        this.nome = nome;
        this.num_matricula = num_matricula;
        this.qualificacao = qualificacao;
    ...
    public void alterar(String novo_nome, String novo_num_matricula,
            String nova_qualificacao, String nova_descricao_qualificacao,
            String nova_carga_horaria_semanal) {
        this.nome = novo_nome;
    ...
    public String getCarga_horaria_semanal() {
        return carga_horaria_semanal;
    }

    public void setCarga_horaria_semanal(String carga_horaria_semanal) {
        this.carga_horaria_semanal = carga_horaria_semanal;
    }
}
